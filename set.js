...
global.caption = "*©𝟐𝟎𝟐𝟓 𝐒𝐎𝐔𝐑𝐀𝐉𝐈𝐓 𝐀𝐈 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "> *POWDERED BY SOURAJIT-AI*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Uetx0aBB#RItz3cKOl4BIN6aNwX-VCgwbUPbzSNoXdoE8mn8dfJY", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "916909950582", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "916909950582", // Only 1 owner Number Here, others Add to sudo numbers...
